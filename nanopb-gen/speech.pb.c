...
const pb_field_t rokid_open_speech_v2_SpeechResponse_fields[9] = {
    ...
    PB_FIELD( 11, STRING  , OPTIONAL, CALLBACK, OTHER, rokid_open_speech_v2_SpeechResponse, voice_trigger, extra, 0),
    PB_LAST_FIELD
};
