...
typedef struct _rokid_open_speech_v2_SpeechResponse {
    ...
    pb_callback_t extra;
    pb_callback_t asr_scores;
    pb_callback_t vpr;
    pb_callback_t asr_phoneticisms;
    pb_callback_t voice_trigger;
...
#define rokid_open_speech_v2_SpeechOptions_init_default {false, _rokid_open_speech_v2_Lang_MIN, false, _rokid_open_speech_v1_Codec_MIN, false, _rokid_open_speech_v2_VadMode_MIN, false, 0, false, 0, false, 0, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, false, 0, false, 0, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, false, 0}
...
#define rokid_open_speech_v2_SpeechResponse_init_default {0, _rokid_open_speech_v2_RespType_MIN, _rokid_open_speech_v1_SpeechErrorCode_MIN, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define rokid_open_speech_v2_SpeechOptions_init_zero {false, _rokid_open_speech_v2_Lang_MIN, false, _rokid_open_speech_v1_Codec_MIN, false, _rokid_open_speech_v2_VadMode_MIN, false, 0, false, 0, false, 0, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, false, 0, false, 0, {{NULL}, NULL}, {{NULL}, NULL}, false, 0, false, 0}
...
#define rokid_open_speech_v2_SpeechResponse_init_zero {0, _rokid_open_speech_v2_RespType_MIN, _rokid_open_speech_v1_SpeechErrorCode_MIN, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define rokid_open_speech_v2_SpeechResponse_asr_scores_tag 8
#define rokid_open_speech_v2_SpeechResponse_vpr_tag 9
#define rokid_open_speech_v2_SpeechResponse_asr_phoneticisms_tag 10
...
extern const pb_field_t rokid_open_speech_v2_SpeechResponse_fields[12];
